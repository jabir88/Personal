...
class Effects21 extends Modules {
    ...
    public function register_front_number_settings() {
        ...
        $this->add_responsive_control(
            ...
            'label' => __('Number Size', OXI_FLIP_BOX_TEXTDOMAIN),
          ...
          $this->add_responsive_control(
            ...
            'label' => __('Height & Width', OXI_FLIP_BOX_TEXTDOMAIN),
            'type' => Controls::SLIDER,
            'default' => [
                'unit' => 'px',
                'size' => 60,
        ...
        $this->add_group_control(
                'oxi-image-flip-front-number-background', $this->style, [
            'type' => Controls::BACKGROUND,
            'selector' => [
        ...
        $this->add_group_control(
                'oxi-image-flip-front-number-border', $this->style, [
            'type' => Controls::BORDER,
            'selector' => [
                '{{WRAPPER}} .oxi-image-hover-figure-front-section .oxi-image-hover-number' => '',
            ]
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-image-hover-figure-front-section .oxi-image-hover-number-section ' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ]
                ]
        );
        $this->add_group_control(
                'oxi-image-flip-front-number-boxshadow', $this->style, [
            'type' => Controls::BOXSHADOW,
            'selector' => [
                '{{WRAPPER}} .oxi-image-hover-figure-front-section .oxi-image-hover-number' => '',
            ],
