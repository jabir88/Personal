...
namespace OXI_IMAGE_HOVER_UPLOADS\Flipbox\Render;
...
class Effects17 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-flipbox-style-17', OXI_IMAGE_HOVER_UPLOAD_URL . '/Flipbox/Files/style-17.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($child as $key => $val) {
            ...
            if ($value['image_hover_front_heading'] != ''):
                $frontheading = '<div class="oxi-image-hover-heading ">' . $this->text_render($value['image_hover_front_heading']) . '</div>';
            endif;
...
//               = '<div class="oxi-image-hover-icon">' . $this->font_awesome_render($value['image_hover_front_icon']) . '</div>';
//            endif;
...
//            endif;
            ...
            echo '  <div class="oxi-image-hover-style ' . $this->column_render('oxi-image-hover-col', $style) . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . '"  ' . $this->animation_render('oxi-image-hover-animation', $style) . '>
                        <div class="oxi-image-hover-style-flipbox">
                            ' . $hr . '
                                <div class="oxi-image-hover oxi-image-flipbox-hover oxi-image-flipbox-hover-style-17 oxi-image-flipbox-hover-' . $this->oxiid . '-' . $val['id'] . '">
                                    <div class="oxi-image-hover-figure oxi-image-flip-top-to-bottom ' . $style['image_hover_effects'] . ' ' . $style['image_hover_timing_type'] . '">
                                        ...
                                        <div class="oxi-image-hover-figure-backend">
                                            <div class="oxi-image-hover-figure-back-section ">
                                                <div class="oxi-image-hover-figure-backend-section-body ' . $this->style['oxi-image-flip-back-content-alignment'] . '">
