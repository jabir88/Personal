...
class Effects13 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-flipbox-style-13', OXI_IMAGE_HOVER_UPLOAD_URL . '/Flipbox/Files/style-13.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($child as $key => $val) {
            ...
            $frontheading = $backheading = $frontcontent = $backcontent = $frontnum = $backicon = $button = $hr = $ht = '';
...
//            endif;
            if ($value['image_hover_front_number'] != ''):
                $frontnum = '<div class="oxi-image-hover-number">' . $this->text_render($value['image_hover_front_number']) . '</div>';
            endif;
...
//            endif;
            ...
            echo '  <div class="oxi-image-hover-style ' . $this->column_render('oxi-image-hover-col', $style) . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . '"  ' . $this->animation_render('oxi-image-hover-animation', $style) . '>
                        <div class="oxi-image-hover-style-flipbox">
                            ' . $hr . '
                                <div class="oxi-image-hover oxi-image-flipbox-hover oxi-image-flipbox-hover-style-13 oxi-image-flipbox-hover-' . $this->oxiid . '-' . $val['id'] . '">
                                        ...
                                        <div class="oxi-image-hover-figure-frontend">
                                            <div class="oxi-image-hover-figure-front-section-body">
                                                <div class="oxi-image-hover-figure-front-section ' . $this->style['oxi-image-flip-front-alignment'] . '">
                                                     ' . $frontnum . $frontheading . $frontcontent . '  
                                                </div>
                                            </div>
                                        </div>
                                        <div class="oxi-image-hover-figure-backend">
                                            <div class="oxi-image-hover-figure-backend-section-body">
                                                <div class="oxi-image-hover-figure-back-section ' . $this->style['oxi-image-flip-back-content-alignment'] . '">
                                                       ' . $backicon . $backheading . $backcontent . $button . '
                                                </div>
                                            </div>
                                        </div>
                                    </div>
