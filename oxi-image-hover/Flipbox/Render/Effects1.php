...
class Effects1 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-flipbox-style-1', OXI_IMAGE_HOVER_UPLOAD_URL . '/Flipbox/Files/style-1.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
...
//            endif;
            ...
            echo '  <div class="oxi-image-hover-style ' . $this->column_render('oxi-image-hover-col', $style) . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . '"  ' . $this->animation_render('oxi-image-hover-animation', $style) . '>
                        <div class="oxi-image-hover-style-flipbox">
                            ' . $hr . '
                                <div class="oxi-image-hover oxi-image-flipbox-hover oxi-image-flipbox-hover-style-1 oxi-image-flipbox-hover-' . $this->oxiid . '-' . $val['id'] . '">
