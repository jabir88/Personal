...
//                $backheading = '<div class="oxi-image-hover-heading ' . $this->style['oxi-image-flip-back-heading-animation'] . ' ' . $this->style['oxi-image-flip-back-animation-delay'] . '">' . $this->text_render($value['image_hover_back_heading']) . '</div>';
//            endif;
...
//            endif;
            ...
            echo '  <div class="oxi-image-hover-style ' . $this->column_render('oxi-image-hover-col', $style) . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . '"  ' . $this->animation_render('oxi-image-hover-animation', $style) . '>
                        <div class="oxi-image-hover-style-flipbox">
                            ' . $hr . '
                                <div class="oxi-image-hover oxi-image-flipbox-hover oxi-image-flipbox-hover-style-11 oxi-image-flipbox-hover-' . $this->oxiid . '-' . $val['id'] . '">
