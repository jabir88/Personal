...
class Effects21 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-flipbox-style-21', OXI_IMAGE_HOVER_UPLOAD_URL . '/Flipbox/Files/style-21.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($child as $key => $val) {
            ...
            $frontheading = $backheading  = $backcontent = $frontnum = $backicon = $button = $hr = $ht = '';
...
//            endif;
            ...
            echo '  <div class="oxi-image-hover-style ' . $this->column_render('oxi-image-hover-col', $style) . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . '"  ' . $this->animation_render('oxi-image-hover-animation', $style) . '>
                        <div class="oxi-image-hover-style-flipbox">
                            ' . $hr . '
                                <div class="oxi-image-hover oxi-image-flipbox-hover oxi-image-flipbox-hover-style-21 oxi-image-flipbox-hover-' . $this->oxiid . '-' . $val['id'] . '">
                                    <div class="oxi-image-hover-figure ' . $style['image_hover_effects'] . ' ' . $style['image_hover_timing_type'] . '">
                                        <div class="oxi-image-hover-figure-frontend">
                                            <div class="oxi-image-hover-figure-front-section-body">
                                                ...
                                                <div class="oxi-image-hover-number-section">' . $frontnum .'</div>
                                                    '. $frontheading  . '  
                                                </div>
                                            </div>
                                        </div>
