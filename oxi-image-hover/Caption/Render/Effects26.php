...
class Effects26 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-caption-splash-effects', OXI_IMAGE_HOVER_UPLOAD_URL . '/Caption/Files/splash-effects.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
