...
class Effects6 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-caption-circle-effects', OXI_IMAGE_HOVER_UPLOAD_URL . '/Caption/Files/circle-effects.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
