...
class Effects16 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-caption-modal-effects', OXI_IMAGE_HOVER_UPLOAD_URL . '/Caption/Files/modal-effects.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($child as $key => $val) {
            ...
            echo '  <div class="oxi-image-hover-style-caption">
                        <div class="oxi-image-hover oxi-image-caption-hover oxi-image-caption-hover-style-26 '.$this->style['image_hover_effects'].'">
