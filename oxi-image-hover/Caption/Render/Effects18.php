...
class Effects18 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-caption-pivot-effects', OXI_IMAGE_HOVER_UPLOAD_URL . '/Caption/Files/pivot-effects.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
