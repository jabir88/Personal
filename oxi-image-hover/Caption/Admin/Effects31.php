...
class Effects31 extends Modules {
    ...
    public function register_effects() {
        return $this->add_control(
                    ...
                    'default' => '',
                    'options' => [
                        'oxi-image-zoom-in' => __('Zoom In', OXI_IMAGE_HOVER_TEXTDOMAIN),
                        'oxi-image-zoom-out' => __('Zoom Out', OXI_IMAGE_HOVER_TEXTDOMAIN),
                        'oxi-image-zoom-out-up' => __('Zoom Out Up', OXI_IMAGE_HOVER_TEXTDOMAIN),
                        'oxi-image-zoom-out-down' => __('Zoom Out Down', OXI_IMAGE_HOVER_TEXTDOMAIN),
                        'oxi-image-zoom-out-left' => __('Zoom Out Left', OXI_IMAGE_HOVER_TEXTDOMAIN),
                        'oxi-image-zoom-out-right' => __('Zoom Out Right', OXI_IMAGE_HOVER_TEXTDOMAIN),
                        'oxi-image-zoom-out-flip-horizontal' => __('Zoom Out Flip Horizontal', OXI_IMAGE_HOVER_TEXTDOMAIN),
                        'oxi-image-zoom-out-flip-vertical' => __('Zoom Out Flip Vertical', OXI_IMAGE_HOVER_TEXTDOMAIN),
                    ],
                    'selector' => [
