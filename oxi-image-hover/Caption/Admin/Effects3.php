...
class Effects3 extends Modules {
    ...
    public function register_effects() {
        return $this->add_control(
                    ...
                    'default' => '',
                    'options' => [
                        'oxi-image-book-open-horizontal' => __('Book Horizontal', OXI_IMAGE_HOVER_TEXTDOMAIN),
                        'oxi-image-book-open-vertical' => __('Book Vertical', OXI_IMAGE_HOVER_TEXTDOMAIN),
                        'oxi-image-book-open-up' => __('Book Open Up', OXI_IMAGE_HOVER_TEXTDOMAIN),
                        'oxi-image-book-open-down' => __('Book Open Down', OXI_IMAGE_HOVER_TEXTDOMAIN),
                        'oxi-image-book-open-left' => __('Book Open Left', OXI_IMAGE_HOVER_TEXTDOMAIN),
                        'oxi-image-book-open-right' => __('Book Open Right', OXI_IMAGE_HOVER_TEXTDOMAIN),
