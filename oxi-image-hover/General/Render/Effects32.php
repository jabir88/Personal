...
namespace OXI_IMAGE_HOVER_UPLOADS\General\Render;
...
class Effects32 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-general-style-32', OXI_IMAGE_HOVER_UPLOAD_URL . '/General/Files/style-32.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($child as $key => $val) {
            ...
            echo '<div class="oxi-image-hover-style oxi-image-hover-style-32 ' . $this->column_render('oxi-image-hover-col', $style) . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . '" ' . $this->animation_render('oxi-image-hover-animation', $style) . '>';
            echo '  <div class="oxi-image-hover-style-general">
                        <div class="oxi-image-hover oxi-image-general-hover oxi-image-general-hover-style-32 oxi-image-general-hover-' . $this->oxiid . '-' . $val['id'] . '">
                            ' . $hr . '
    ...
    public function old_render() {
        ...
        $new = [
            ...
            'oxi-image-hover-content-margin-lap-top' => $styledata[29],
            'oxi-image-hover-content-margin-lap-right' => $styledata[29],
            'oxi-image-hover-content-margin-lap-bottom' => $styledata[29],
            'oxi-image-hover-content-margin-lap-left' => $styledata[29],
            ...
            'oxi-image-hover-hover-boxshadow-type' => '',
            'oxi-image-hover-hover-boxshadow-spread-size' => $styledata[25],
            'oxi-image-hover-hover-boxshadow-color' => $styledata[27],
            //////
            ...
            'oxi-image-hover-heading-margin-lap-bottom' => $styledata[43],
            ...
            'oxi-image-hover-underline-distance-lap-size' => $styledata[45],
            /////
        ...
        $cls = '\OXI_IMAGE_HOVER_UPLOADS\General\Admin\\Effects' . $name[1];
        $CLASS = new $cls('admin');
