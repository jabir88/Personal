...
class Effects30 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-general-style-30', OXI_IMAGE_HOVER_UPLOAD_URL . '/General/Files/style-30.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($child as $key => $val) {
            ...
            echo '<div class="oxi-image-hover-style oxi-image-hover-style-30 oxi-image-general-hover-style-30-' . $this->oxiid . ' ' . $this->column_render('oxi-image-hover-col', $style) . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . '" ' . $this->animation_render('oxi-image-hover-animation', $style) . '>';
            echo '  <div class="oxi-image-hover-style-general">
                        <div class="oxi-image-hover oxi-image-general-hover oxi-image-general-hover-style-30 oxi-image-general-hover-' . $this->oxiid . '-' . $val['id'] . '">
                            ' . $hr . '
    ...
    public function old_render() {
        ...
        $new = [
            ...
            ///
            'image-hover-custom-css' => $styledata[85],
            'oxi-image-hover-heading-hover-color' => $styledata[83],
        ];
        $row = json_encode($new);
