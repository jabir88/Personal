...
class Effects29 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-general-style-29', OXI_IMAGE_HOVER_UPLOAD_URL . '/General/Files/style-29.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($child as $key => $val) {
            ...
            echo '  <div class="oxi-image-hover-style-general">
                        <div class="oxi-image-hover oxi-image-general-hover oxi-image-general-hover-style-29 oxi-image-general-hover-' . $this->oxiid . '-' . $val['id'] . '">
                            ' . $hr . '
