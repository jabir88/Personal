...
class Effects21 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-square-style-21', OXI_IMAGE_HOVER_UPLOAD_URL . '/Square/Files/style-21.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
    ...
    public function old_render() {
        ...
        $new = [
            ...
            'oxi-image-hover-content-height-lap-size' => ($styledata[7] * $styledata[3] / 100 + 40),
