...
namespace OXI_IMAGE_HOVER_UPLOADS\Square\Render;
...
class Effects15 extends Public_Render {

    public function public_css() {
        wp_enqueue_style('oxi-image-hover-square', OXI_IMAGE_HOVER_UPLOAD_URL . '/Square/Files/square.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
        wp_enqueue_style('oxi-image-hover-square-style-15', OXI_IMAGE_HOVER_UPLOAD_URL . '/Square/Files/style-15.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($child as $key => $val) {
            ...
            if ($value['image_hover_heading'] != ''):
                $text = '<div class="oxi-image-hover-figure-heading ' . $this->style['oxi-image-hover-heading-animation'] . ' ' . $this->style['oxi-image-hover-heading-animation-delay'] . '"><h3 class="oxi-image-hover-heading ' . $this->style['oxi-image-hover-heading-underline'] . '">' . $this->text_render($value['image_hover_heading']) . '</h3></div>';
            endif;
            ...
            echo '<div class="oxi-image-hover-style oxi-image-hover-style-15-square ' . $this->column_render('oxi-image-hover-col', $style) . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . '" ' . $this->animation_render('oxi-image-hover-animation', $style) . '>';
            echo '  <div class="oxi-image-hover-style-square">
                        <div class="oxi-image-hover oxi-image-square-hover oxi-image-square-hover-style-15 oxi-image-square-hover-' . $this->oxiid . '-' . $val['id'] . '">
                            ' . $hr . '
    ...
    public function old_render() {
        ...
        $new = [
            ...
            'oxi-image-hover-heading-background-color' => '',
            'oxi-image-hover-background-img' => '',
            /////
            'oxi-image-hover-heading-underline' => ($styledata[41] == 'yes' ? 'oxi-image-hover-heading-underline' : ''),
