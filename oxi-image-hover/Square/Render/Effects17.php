...
class Effects17 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-square-style-17', OXI_IMAGE_HOVER_UPLOAD_URL . '/Square/Files/style-17.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($child as $key => $val) {
            ...
            echo '  <div class="oxi-image-hover-style-square">
                        <div class="oxi-image-hover oxi-image-square-hover oxi-image-square-hover-style-17 oxi-image-square-hover-' . $this->oxiid . '-' . $val['id'] . '">
                            ' . $hr . '
    ...
    public function old_render() {
        ...
        $new = [
            ...
            'oxi-image-hover-content-height-lap-size' => $styledata[3],
