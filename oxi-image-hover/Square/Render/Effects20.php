...
class Effects20 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-square-style-20', OXI_IMAGE_HOVER_UPLOAD_URL . '/Square/Files/style-20.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($child as $key => $val) {
            ...
            echo '<div class="oxi-image-hover-style oxi-image-hover-style-20-square ' . $this->column_render('oxi-image-hover-col', $style) . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . '" ' . $this->animation_render('oxi-image-hover-animation', $style) . '>';
            echo '  <div class="oxi-image-hover-style-square">
                        <div class="oxi-image-hover oxi-image-square-hover oxi-image-square-hover-style-20 oxi-image-square-hover-' . $this->oxiid . '-' . $val['id'] . '">
                            ' . $hr . '
    ...
    public function old_render() {
        ...
        $new = [
            ...
            ///
            'oxi-image-hover-button-margin-lap-top' => $styledata[11],
            'oxi-image-hover-button-margin-lap-right' => $styledata[11],
            'oxi-image-hover-button-margin-lap-bottom' => $styledata[11],
            'oxi-image-hover-button-margin-lap-left' => $styledata[11],
