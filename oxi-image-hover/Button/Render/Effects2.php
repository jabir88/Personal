...
class Effects2 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-button-style-2', OXI_IMAGE_HOVER_UPLOAD_URL . '/Button/Files/style-2.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($child as $key => $val) {
            ...
            echo '  <div class="oxi-image-hover-style-button">
                        <div class="oxi-image-hover oxi-image-button-hover oxi-image-button-hover-style-2 oxi-image-button-hover-' . $this->oxiid . '-' . $val['id'] . '">
