    ...
    */
    ...
    var LightboxPanel = {
        ...
        created: function() {
            ...
            this.caption = $('.bdt-lightbox-caption', this.$el);
    ...
    function getIframe(src, width$$1, height$$1, autoplay) {
        return ("<iframe src=\"" + src + "\" width=\"" + width$$1 + "\" height=\"" + height$$1 + "\" style=\"max-width: 100%; box-sizing: border-box;\" frameborder=\"0\" allowfullscreen bdt-video=\"autoplay: " + autoplay + "\" bdt-responsive></iframe>");
    }
        ...
        update: {
            ...
            write: function() {
                ...
                $$(("[" + (this.attrItem) + "],[data-" + (this.attrItem) + "]"), this.$el).forEach(function (el) {
                    ...
                    this$1.maxIndex && toggleClass(el, 'bdt-hidden', isNumeric(index$$1) && (this$1.sets && !includes(this$1.sets, toFloat(index$$1)) || index$$1 > this$1.maxIndex));
                });
