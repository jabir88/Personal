...
class Timeline extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-timeline-divider'                               => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .bdt-timeline .bdt-timeline-line span'               => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .bdt-timeline:not(.bdt-timeline--horizontal):before' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .bdt-timeline .bdt-timeline-item:after'              => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-timeline-skin-olivier .bdt-timeline-item:after' => 'border-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-timeline .bdt-timeline-icon span:before' => 'font-size: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'icon_show' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-timeline .bdt-timeline-icon span:hover:before' => 'color: {{VALUE}} !important;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-timeline .bdt-timeline-icon span:hover:before' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-timeline .bdt-timeline-icon span:hover:before' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-timeline-nav-button' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-timeline-nav-button:hover' => 'color: {{VALUE}} !important;',
				],
			]
		);
	...
	public function render_item( $item_parallax, $align, $item = [] ) {
		...
		?>
		<div class="bdt-timeline-item-main"<?php echo $item_parallax; ?>>
	...
	public function render_date( $align = 'left', $item = [] ) {
		...
		<div class="bdt-timeline-item bdt-width-1-2@m bdt-visible@m">
	  		<div class="bdt-timeline-date bdt-text-<?php echo esc_attr( $align ); ?>"<?php echo $date_parallax; ?>><span><?php echo esc_attr( $timeline_date ); ?></span></div>
		</div>
		<?php
				...
				<div class="bdt-grid bdt-grid-collapse">
					...
					while ( $wp_query->have_posts() ) : $wp_query->the_post();
						...
						<?php endif; ?>
			  			...
			  			<div class="<?php echo ('center' == $align) ? ' bdt-width-1-2@m ' : ' '; ?>bdt-timeline-item <?php echo $item_part . '-part'; ?>">
				  			
				  			<div class="bdt-timeline-item-main-wrapper">
				  				<div class="bdt-timeline-line"><span<?php echo $vertical_line_parallax; ?>></span></div>
					  			<div class="bdt-timeline-item-main-container">
					  				<div class="bdt-timeline-icon bdt-post-format-<?php echo esc_attr($post_format); ?>"<?php echo $icon_parallax; ?>>
					  					<span></span>
					  				</div>
	...
	public function render_custom() {
		...
		?>
		<div id="bdt-timeline-<?php echo esc_attr($id); ?>" class="bdt-timeline bdt-timeline-skin-default bdt-timeline-<?php echo esc_attr($align); ?>">
	  				...
	  				<div class="<?php echo ( 'center' == $align ) ? ' bdt-width-1-2@m ' : ' '; ?>bdt-timeline-item <?php echo $item_part . '-part'; ?>">
			  			...
			  			<div class="bdt-timeline-item-main-wrapper">
				  			...
				  			<div class="bdt-timeline-item-main-container">
				  				...
				  				<div class="bdt-timeline-icon"<?php echo $item_scrollspy; ?>>
				  					<span class="<?php echo esc_attr($item['timeline_icon']); ?>"></span>
				  				</div>
