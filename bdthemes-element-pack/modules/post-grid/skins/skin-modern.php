				...
				while ($wp_query->have_posts()) :
					...
					<?php if ( 1 == $bdt_count ) : ?>
					    <div class="bdt-width-2-5@m bdt-primary">
					        <?php $this->parent->render_post_grid_item( $post->ID, $settings['primary_thumbnail_size'], $settings['excerpt_length'] ); ?>
					    </div>
					...
					<?php endif; ?>
					            <?php if ( 2 == $bdt_count ) : ?>
						            <div class="bdt-width-1-1@m">
						                <?php $this->parent->render_post_grid_item( $post->ID, $settings['secondary_thumbnail_size'], $settings['excerpt_length'] ); ?>
						            </div>
					            <?php endif; ?>
