			...
			if ( $settings['show_logged_in_message'] ) {
				...
				<div class="bdt-user-login bdt-text-center">
					<ul class="bdt-list bdt-list-divider">
						...
						<li class="bdt-user-name">
							<?php esc_html_e( 'Name:', 'bdthemes-element-pack' ); ?> <a href="<?php echo get_edit_user_link(); ?>" class="bdt-text-bold"><?php echo $current_user->display_name; ?></a>
						</li>
