...
class Table_Of_Content extends Widget_Base {
	...
	public function get_script_depends() {
		return [ 'jquery-ui-widget', 'table-of-content', 'bdt-uikit-icon' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-card-secondary'    => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-card-secondary .bdt-nav li a'    => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-card-secondary .bdt-nav > li.bdt-active > a'    => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '#bdt-toc-{{ID}} .bdt-offcanvas-bar .bdt-nav > li > a, {{WRAPPER}} .bdt-card-secondary .bdt-nav > li > a',
			]
		);
	...
	private function layout_fixed() {
		...
		?>
		<div class="table-of-content-layout-fixed bdt-position-<?php echo esc_attr( $settings['fixed_position'] ); ?>">
	...
	private function layout_dropdown() {
		...
		<div class="table-of-content-layout-dropdown">
			<div class="bdt-toggle-button-wrapper bdt-position-fixed bdt-position-<?php echo esc_attr($settings['button_position']); ?>">
				<a id="<?php echo $id; ?>" class="bdt-toggle-button elementor-button elementor-size-sm" href="#">
