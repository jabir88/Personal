...
if (!empty($_POST['submit']) && $_POST['submit'] == 'submit') {
    if (!wp_verify_nonce($nonce, 'oxilab_flip_box_new_data')) {
        ...
        $data = ' flip-box-front-title {#}|{#}' . oxilab_flip_box_admin_special_charecter($_POST['flip-box-front-title']) . '{#}|{#}'
                ...
                . ' flip-box-image-upload-url-01 {#}|{#}' . oxilab_flip_box_admin_special_charecter($_POST['flip-box-image-upload-url-01']) . '{#}|{#}'
                ...
                . ' flip-box-backend-link {#}|{#}' . oxilab_flip_box_admin_special_charecter($_POST['flip-box-backend-link']) . '{#}|{#}'
                . ' flip-box-image-upload-url-02 {#}|{#}' . oxilab_flip_box_admin_special_charecter($_POST['flip-box-image-upload-url-02']) . '{#}|{#}';
