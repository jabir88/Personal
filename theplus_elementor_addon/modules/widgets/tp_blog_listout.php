...
class ThePlus_Blog_ListOut extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::SELECT2,
				'label'      => esc_html__( 'Exclude Tags', 'theplus' ),
				'default'    => '',
				'multiple'   => true,
				'options' => theplus_get_tags(),
				'separator' => 'before',
