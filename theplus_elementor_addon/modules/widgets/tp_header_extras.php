...
protected function _register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'options' => [
					...
					'wpml_lang' => esc_html__( 'Language Switcher (Coming Soon)', 'theplus' ),					
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .header-extra-icons .mini-cart-icon .plus-cart-icon:hover .cart_custom_icon i' => 'color: {{VALUE}}',
				],
			]
		);
	 ...
	 protected function render() {
		...
		if($settings['display_search_bar']=='yes' && $settings['search_icon_style']=='style-custom-icon'){
			ob_start();
			\Elementor\Icons_Manager::render_icon( $settings['search_custom_icon'], [ 'aria-hidden' => 'true' ]);
			$search_custom_icon = ob_get_contents();
			ob_end_clean();						
		}
		if($settings['display_mini_cart']=='yes' && $settings['cart_icon']=='cart_custom_icon'){
			ob_start();
					...
					$meta_content .='<ul class="icons-content-list">';					
						foreach ( $settings['sequence_icons'] as $index => $item ) :
							...
							if($settings["display_extra_toggle_bar"]=='yes' && $select_icon_list=='extra_toggle'){
								...
								$meta_content .='<li class="extra-toggle-icon elementor-repeater-item-' . $item['_id'] . ' '.esc_attr($responsive_class_attr).'">';
									$meta_content .='<div class="content-icon-list">';
									...
									$meta_content .='<li class="mini-cart-icon '.$cart_icon_style.' elementor-repeater-item-' . $item['_id'] . ' '.esc_attr($responsive_class_attr).'">';
										$meta_content .='<div class="content-icon-list">';
											...
											if(!empty($cart_icon_style) && $cart_icon_style=='style-2'){
												...
												$meta_content .='<div class="tpmc-header-extra-toggle-content  '.$mc_fullwidth_content.' '.$settings['cart_icon_direction'].'">';												
							...
							if($settings["display_call_to_action_1"]=='yes' && $select_icon_list=='action_1'){
								...
								$meta_content .='<li class="call-to-action-1 elementor-repeater-item-' . $item['_id'] . ' '.esc_attr($responsive_class_attr).'">';
									$meta_content .='<div class="content-icon-list">';
							...
							if($settings["display_call_to_action_2"]=='yes' && $select_icon_list=='action_2'){
								...
								$meta_content .='<li class="call-to-action-2 elementor-repeater-item-' . $item['_id'] . ' '.esc_attr($responsive_class_attr).'">';
									$meta_content .='<div class="content-icon-list">';
							...
							if($settings["display_music_bar"]=='yes' && $select_icon_list=='music'){
								...
								$meta_content .='<li class="header-music-bar elementor-repeater-item-' . $item['_id'] . ' '.esc_attr($responsive_class_attr).'">';
									$meta_content .='<div class="content-icon-list">';
