		...
		if($logo_type=='image'){
			...
			if($settings["image_logo"]["url"]!=''){				
				...
				$normal_logo = '<a href="'.esc_url($logo_url).'" ' . $target . $nofollow . ' title="'.esc_attr(get_bloginfo()).'" class="site-normal-logo image-logo" >';
					$normal_logo .= '<img src="'.esc_url($logo_image).'" class="image-logo-wrap" alt="'.esc_attr(get_bloginfo()).'">';
				$normal_logo .= '</a>';
			}

			if($settings["logo_animate"]=='double'){
				if($settings["hover_image_logo"]["url"]!=''){					
			...
			if($settings["svg_logo"]["url"]!=''){
				...
				$normal_logo ='<a href="'.esc_url($logo_url).'" ' . $target . $nofollow . ' title="'.esc_attr(get_bloginfo()).'" class="site-normal-logo svg-logo">';
					$normal_logo .='<img class="image-logo-wrap" src="'.esc_url($logo_svg).'" alt="'.esc_attr(get_bloginfo()).'" />';
				$normal_logo .='</a>';
			}
			
			
			if($settings["logo_animate"]=='double'){
				if($settings["hover_svg_logo"]["url"]!=''){
