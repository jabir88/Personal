...
class ThePlus_Dynamic_Devices extends Widget_Base {
    ...
    protected function render() {
		...
		if($settings["device_mode"]=='carousal'){
			...
			$autoplay_speed = ($settings['carousal_autoplay_speed']["size"]!='') ? $settings['carousal_autoplay_speed']["size"] : '4000';
			$speed = ($settings['carousal_speed']["size"]!='') ? $settings['carousal_speed']["size"] : '700';
