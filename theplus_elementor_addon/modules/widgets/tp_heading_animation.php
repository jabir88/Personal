    ...
    protected function _register_controls() {
	 ...
	 protected function render() {
		...
		if ($anim_styles == 'style-2') {
			$heading_animation .='<h1 class="pt-plus-cd-headline rotate-1" >';
			if($prefix != ''){
		...
		if ($anim_styles == 'style-3') {
			$heading_animation .='<h1 class="pt-plus-cd-headline zoom" >';
			if($prefix != ''){
				$heading_animation .='<span >'.esc_html($prefix).' </span>';	
			}	
			$heading_animation .='<span class="cd-words-wrapper">';
		...
		if ($anim_styles == 'style-4') {
			$heading_animation .='<h1 class="pt-plus-cd-headline loading-bar " >';
			if($prefix != ''){
				$heading_animation .='<span >'.esc_html($prefix).' </span>';	
			}
			$heading_animation .='<span class="cd-words-wrapper">';
		...
		if ($anim_styles == 'style-5') {
			$heading_animation .='<h1 class="pt-plus-cd-headline push" >';
			if($prefix != ''){
				$heading_animation .='<span >'.esc_html($prefix).' </span>';	
			}
			$heading_animation .='<span class="cd-words-wrapper">';
