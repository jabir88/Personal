...
class Style16 extends Admin_Render {
    ...
    public function register_controls() {
        ...
        $this->add_group_control(
            ...
            'loader' => TRUE,
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-16' => '',
            ]
                ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-16 *' => 'transition: all {{SIZE}}s ease-in-out !important;',
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-16 .oxi-addons-flip-box-front-style-1' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ...
                '{{WRAPPER}} .oxi-addons-flip-box-style-16 .oxi-addons-flip-box-back-style-1' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_group_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-16 .oxi-addons-flip-box-front-section' => '',
            ]
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-16 .oxi-addons-flip-box-front-icon .oxi-icons' => 'font-size:{{SIZE}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'type' => Controls::BACKGROUND,
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-16 .oxi-addons-flip-box-front-icon' => '',
            ]
                ]
        );
        $this->add_control(
            ...
            'default' => '#ffffff',
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-16 .oxi-addons-flip-box-front-icon .oxi-icons' => 'color: {{VALUE}};',
            ]
                ]
        );
        $this->add_group_control(
        ...
        $this->add_group_control(
                'sa-flip-boxes-icon-box-shadow', $this->style, [
            'type' => Controls::BOXSHADOW,
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-16 .oxi-addons-flip-box-front-icon' => '',
            ]
        ...
        $this->add_group_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-16 .oxi-addons-flip-box-front-headding' => '',
            ]
                ]
        );
        $this->add_group_control(
        ...
        $this->add_group_control(
            ...
            'type' => Controls::BACKGROUND,
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-16 .oxi-addons-flip-box-back-section' => '',
            ]
                ]
        );
        ...
        $this->add_group_control(
            ...
            'include' => Controls::ALIGNNORMAL,
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-16 .oxi-addons-flip-box-back-info' => '',
            ]
                ]
        );
        $this->add_group_control(
